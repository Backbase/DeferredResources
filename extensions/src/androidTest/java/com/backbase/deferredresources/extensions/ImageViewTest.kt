...
class ImageViewTest {
    ...
    @Test fun setImageDrawable_setsResolvedDrawable() = onView<ImageView> {
    ...
    @Test fun setColorFilter_withoutMode_setsColorInAtopMode() = onView<ImageView> {
    ...
    @Test fun setColorFilter_withMode_setsColorInGivenMode() = onView<ImageView> {
